<?php
    ...
    require_once 'elements/properties/shadow.css';
    require_once 'elements/properties/shadow-move.css';
    require_once 'elements/properties/colors/background.css';
    require_once 'elements/properties/colors/colors.css';
    require_once 'elements/properties/paddings&margin/pm.css';
    require_once 'elements/properties/text/text.css';
